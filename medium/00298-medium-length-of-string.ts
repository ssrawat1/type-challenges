...
type CreateTuple<T extends string, A extends string[] = []> = T extends `${infer F}${infer R}` ? CreateTuple<R, [...A, F]> : A["length"]

type LengthOfString<S extends string> = CreateTuple<S>
