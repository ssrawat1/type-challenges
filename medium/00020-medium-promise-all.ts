...
type UnwrapPromise<X> = X extends Promise<infer R> ? R : X;

type MapPromise<T extends any[]> = number extends T['length']
  ? UnwrapPromise<T[number]>[]
  : { [P in keyof T]: T[P] extends Promise<infer R> ? R : T[P] };

declare function PromiseAll<T extends any[]>(values: readonly [...T]): Promise<MapPromise<T>>;
